...
$this->bbii_breadcrumbs=array(
	...
	$model->member_name . Yii::t('bbii', '\'s profile')=>array('forum/member/view','id'=>$model->id),
	Yii::t('bbii', 'Update')
);
...
<div id="bbii-wrapper">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="row" style="clear:both;">
			...
			<?php echo $form->dropDownList($model,'gender',array(''=>'','0'=>Yii::t('bbii', 'Male'),'1'=>Yii::t('bbii', 'Female'))); ?>
		...
		<div class="row">
			...
			<?php echo $form->dropDownList($model,'show_online',array('0'=>Yii::t('bbii', 'No'),'1'=>Yii::t('bbii', 'Yes'))); ?>
			<?php echo $form->error($model,'show_online'); ?>
		</div>

		<div class="row">
			<?php echo $form->labelEx($model,'contact_email'); ?>
			<?php echo $form->dropDownList($model,'contact_email',array('0'=>Yii::t('bbii', 'No'),'1'=>Yii::t('bbii', 'Yes'))); ?>
			<?php echo $form->error($model,'contact_email'); ?>
		</div>

		<div class="row">
			<?php echo $form->labelEx($model,'contact_pm'); ?>
			<?php echo $form->dropDownList($model,'contact_pm',array('0'=>Yii::t('bbii', 'No'),'1'=>Yii::t('bbii', 'Yes'))); ?>
		...
		<div class="row">
			...
			<?php echo Yii::t('bbii', 'Large images will be resized to fit a size of 90 pixels by 90 pixels.'); ?>
		...
		<?php echo CHtml::link(Yii::t('bbii', 'My presence on the internet'),'#',array('class'=>'presence-button')); ?>
