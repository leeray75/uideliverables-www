...
<div id="bbii-footer">
	<table><tr>
		<td class="online">
			<div>
				<span class="header2"><?php echo Yii::t('bbii','{guests} guest(s) and {members} active member(s)', array('{guests}'=>($present - $members), '{members}'=>$members));?></span>
			...
			<div>
				...
				?>
				<?php echo Yii::t('bbii','({hidden} anonymous member(s))', array('{hidden}'=>BbiiMember::model()->hidden()->present()->count())); ?>
			</div>
		</td>
		<td class="statistics">
			<table>
