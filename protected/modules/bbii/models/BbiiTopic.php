...
class BbiiTopic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('forum_id, user_id, first_post_id, last_post_id, num_replies, num_views, moved, approved, locked, sticky, global', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'forum_id' => Yii::t('bbii', 'Forum'),
			'user_id' => 'User',
			'title' => Yii::t('bbii', 'Title'),
			'first_post_id' => 'First Post',
			'last_post_id' => 'Last Post',
			'num_replies' => Yii::t('bbii', 'replies'),
			'num_views' => Yii::t('bbii', 'views'),
			'approved' => 'Approved',
			'locked' => Yii::t('bbii', 'Locked'),
			'sticky' => Yii::t('bbii', 'Sticky'),
			'global' => Yii::t('bbii', 'Global'),
			'moved' => 'Moved',
			'merge' => Yii::t('bbii', 'Merge with topic'),
		);
	}
