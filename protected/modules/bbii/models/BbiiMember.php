...
class BbiiMember extends CActiveRecord {
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'image' => Yii::t('bbii', 'Upload a new avatar'),
			'remove_avatar' => Yii::t('bbii', 'Remove your avatar'),
			'member_name' => Yii::t('bbii', 'Name to display'),
			'gender' => Yii::t('bbii', 'Gender'),
			'birthdate' => Yii::t('bbii', 'Birthdate'),
			'location' => Yii::t('bbii', 'Location'),
			'personal_text' => Yii::t('bbii', 'Profile text'),
			'signature' => Yii::t('bbii', 'Signature'),
			'avatar' => 'Avatar',
			'show_online' => Yii::t('bbii', 'Show when online'),
			'contact_email' => Yii::t('bbii', 'Allow members to contact you by e-mail'),
			'contact_pm' => Yii::t('bbii', 'Allow members to contact you by private messaging'),
			'timezone' => Yii::t('bbii', 'Time zone'),
			'first_visit' => 'First Visit',
			'last_visit' => 'Last Visit',
			'warning' => 'Warning',
			'posts' => 'Posts',
			'group_id' => Yii::t('bbii', 'Group'),
			'upvoted' => 'Upvoted',
			'blogger' => Yii::t('bbii', 'My Blogger blog'),
			'facebook' => Yii::t('bbii', 'My Facebook page'),
			'flickr' => Yii::t('bbii', 'My Flickr account'),
			'google' => Yii::t('bbii', 'My Google+ page'),
			'linkedin' => Yii::t('bbii', 'My Linkedin page'),
			'metacafe' => Yii::t('bbii', 'My Metacafe channel'),
			'myspace' => Yii::t('bbii', 'My Myspace page'),
			'orkut' => Yii::t('bbii', 'My Orkut page'),
			'tumblr' => Yii::t('bbii', 'My Tumblr blog'),
			'twitter' => Yii::t('bbii', 'My Twitter page'),
			'website' => Yii::t('bbii', 'My website'),
			'wordpress' => Yii::t('bbii', 'My Wordpress blog'),
			'yahoo' => Yii::t('bbii', 'Yahoo'),
			'youtube' => Yii::t('bbii', 'My Youtube channel'),
			'moderator' => Yii::t('bbii', 'Moderator'),
		);
	}
