/*
	...
	Modified: Added a callbacks to the options before & after setSelection is called.
*/
(function ($) {
    $.rateit = {
        aria : {
    ...
    $.fn.rateit = function (p1, p2) {
        ...
        return this.each(function () {
            ...
            if (!itemdata('init')) {
				...
				itemdata('afterSelection', itemdata('afterSelection') || options.afterSelection);
            ...
            var setSelection = function (value) {
				if(typeof(options.beforeSelection) == "function")
				{
					options.beforeSelection(itemdata('value'));
				}				
				...
				if(typeof(options.afterSelection) == "function")
				{
					options.afterSelection(value);
				}
            };
